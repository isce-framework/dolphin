...
def run(
    ...
    unwrapped_paths, conncomp_paths = unwrap.run(
        ...
        snaphu_options=unwrap_options.snaphu_options,
        tophu_options=unwrap_options.tophu_options,
        spurt_options=unwrap_options.spurt_options,
        scratchdir=unwrap_scratchdir,
        run_goldstein=unwrap_options.run_goldstein,
        run_interpolation=unwrap_options.run_interpolation,
        preprocess_options=unwrap_options.preprocess_options,
